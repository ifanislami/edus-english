...
function ReadingModule({ onBack }) {
  ...
  const getVocab = (aid) => ARTICLE_VOCAB.filter(v=>v.aid===aid);
  const getQuiz = (aid) => RD_QUIZ.filter(q=>q.aid===aid);
  ...
  return (
    <div style={{ minHeight:"100vh",background:"#faf7f2",fontFamily:"'Source Sans 3',sans-serif" }}>
      ...
      <div style={{ position:"sticky",top:48,zIndex:150,background:"rgba(250,247,242,0.97)",backdropFilter:"blur(8px)",borderBottom:"1px solid #e0dcd5" }}>
        <div style={{ maxWidth:1100,margin:"0 auto",padding:"0 24px",display:"flex",gap:2,overflowX:"auto" }}>
          {RD_CATEGORIES.map(c => (
